/* script para o calculo das alterações matematicas
-soma
-subtração
-divisão
-multiplicação
-resto
será necessario mais 2 variaveis para receber os numeros dos usuarios*/
var numero1;
var numero2;
...
numero2 = prompt("Digete outro Numero");
